...
| 음성 인증 | [`코드 설명`](Source/02_SessionAndVoice/README.md) · [`LambdaTokenProvider.cs`](Source/02_SessionAndVoice/LambdaTokenProvider.cs) · [`VivoxBootstrap.cs`](Source/02_SessionAndVoice/VivoxBootstrap.cs) | Steam 출시 빌드에 적용한 UGS 기반 서버리스 토큰 발급과 Vivox 초기화, 채널 참가 |
